  ...
  return (
    <main className="min-h-screen bg-surface">
      <div className="max-w-3xl mx-auto px-6 py-16">
        <h1 className="text-4xl font-bold text-fg mb-6">About Free For NonProfits</h1>
        ...
        <h2 className="text-2xl font-semibold text-fg mt-12 mb-4">What we cover</h2>
        ...
        <h2 className="text-2xl font-semibold text-fg mt-12 mb-4">Submit a tool</h2>
        ...
        <a
          href="/tools"
          className="inline-block rounded-lg bg-accent px-6 py-3 text-sm font-semibold text-accent-fg hover:bg-accent-hover transition-colors"
        >
          Browse all tools →
        </a>
      </div>
